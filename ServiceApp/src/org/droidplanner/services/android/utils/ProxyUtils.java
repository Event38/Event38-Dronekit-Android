...
import com.o3dr.services.android.lib.drone.mission.item.spatial.LoiterToAlt;
...
import org.droidplanner.services.android.core.mission.waypoints.LoiterToAltImpl;
    ...
    public static MissionItemImpl getMissionItemImpl(Mission mission, MissionItem proxyItem) {
        ...
        switch (proxyItem.getType()) {
            ...
            case LOITER_TO_ALT: {
                ...
                LoiterToAltImpl temp = new LoiterToAltImpl(mission, (proxy.getCoordinate()));
                temp.setRadius(proxy.getRadius());
                temp.setHeading(proxy.getHeading());
    ...
    public static MissionItem getProxyMissionItem(MissionItemImpl itemImpl) {
        ...
        switch (itemImpl.getType()) {
           ...
           case LOITER_TO_ALT: {
                ...
                temp.setCoordinate((source.getCoordinate()));
                temp.setRadius(source.getRadius());
                temp.setHeading (source.getHeading());
